    ...
    <section class="about-us" id="about">
        <div class="container">
            <div class="section-header">
                ...
                <h2 class="section-title">MAISON DE MODÈLES</h2>
                <p class="section-description">Мы создаём профессиональную среду для развития детей в модельной индустрии</p>
            </div>
                ...
                <div class="about-hero-content">
                    <div class="about-stats-group">
                        ...
                        <div class="about-stat">
                            ...
                            <div class="stat-text">партнёров</div>
                        </div>
                        <div class="about-stat">
                            <div class="stat-number">100%</div>
                            <div class="stat-text">трудоустройство</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="about-story">
                <div class="story-content">
                    <h3>Наша история</h3>
                    <p>
                        MAISON DE MODÈLES был основан в 2018 году командой профессионалов из модельной индустрии с многолетним опытом работы на международных подиумах и в рекламных кампаниях ведущих брендов.
                    </p>
                    <p>
                        Наша миссия — открыть двери в мир моды для талантливых детей, предоставив им профессиональное обучение, безопасную среду для развития и реальные возможности для карьеры в модельном бизнесе.
                    </p>
                    <p>
                        За годы работы мы выпустили более 500 учеников, многие из которых успешно работают с ведущими российскими и международными брендами, снимаются для глянцевых журналов и участвуют в показах Mercedes-Benz Fashion Week.
                    </p>
                </div>
                <div class="story-image">
                    <img src="https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=700&h=900&fit=crop" alt="Наша школа">
                </div>
            </div>
            ...
            <div class="mission-values">
                ...
                <div class="values-grid">
                    <div class="value-card">
                        ...
                        <p>Наши преподаватели — действующие модели, стилисты и хореографы с опытом работы на международных показах</p>
                    </div>
                    ...
                    <div class="value-card">
                        ...
                        <h4>Забота о детях</h4>
                        <p>Создаём безопасную и комфортную атмосферу, где каждый ребёнок чувствует себя уверенно и защищено</p>
                    </div>
                    ...
                    <div class="value-card">
                        ...
                        <p>Работаем с каждым ребёнком персонально, раскрывая его уникальность и развивая сильные стороны</p>
                    </div>
                    ...
                    <div class="value-card">
                        ...
                        <p>Даём не только знания, но и реальные возможности: съёмки, показы, контракты с брендами</p>
                    </div>
                </div>
            </div>
            ...
            <div class="team-section">
                ...
                <p class="team-subtitle">Профессионалы с опытом работы в ведущих модельных агентствах</p>
                
                <div class="team-grid">
                    <div class="team-card">
                        <div class="team-photo">
                            <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400&h=500&fit=crop" alt="Елена Соколова">
                        </div>
                        <div class="team-info">
                            <h4>Елена Соколова</h4>
                            <p class="team-position">Основатель и директор</p>
                            <p class="team-bio">15 лет в модельном бизнесе. Работала на Mercedes-Benz Fashion Week, сотрудничала с Vogue, Elle, Harper's Bazaar</p>
                        </div>
                    </div>

                    <div class="team-card">
                        <div class="team-photo">
                            <img src="https://images.unsplash.com/photo-1580489944761-15a19d654956?w=400&h=500&fit=crop" alt="Ирен Ким">
                        </div>
                        <div class="team-info">
                            <h4>Ирен Ким</h4>
                            <p class="team-position">Ведущий педагог по дефиле</p>
                            <p class="team-bio">Модель международного уровня. Участвовала в показах в Париже, Милане и Нью-Йорке. Опыт преподавания 8 лет</p>
                        </div>
                    </div>

                    <div class="team-card">
                        <div class="team-photo">
                            <img src="https://images.unsplash.com/photo-1557862921-37829c790f19?w=400&h=500&fit=crop" alt="Анна Петрова">
                        </div>
                        <div class="team-info">
                            <h4>Анна Петрова</h4>
                            <p class="team-position">Фотопозирование</p>
                            <p class="team-bio">Профессиональный фотограф и модельер. Работала с ведущими глянцевыми изданиями России</p>
                        </div>
                    </div>

                    <div class="team-card">
                        <div class="team-photo">
                            <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=500&fit=crop" alt="Дмитрий Волков">
                        </div>
                        <div class="team-info">
                            <h4>Дмитрий Волков</h4>
                            <p class="team-position">Актёрское мастерство</p>
                            <p class="team-bio">Актёр театра и кино. Специализируется на развитии уверенности и раскрепощении детей</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="achievements">
                <h3 class="achievements-title">Наши достижения</h3>
                <div class="achievements-list">
                    <div class="achievement-item">
                        <div class="achievement-year">2018</div>
                        <div class="achievement-content">
                            <h4>Основание школы</h4>
                            <p>Открытие первого набора — 15 учеников</p>
                        </div>
                    </div>
                    ...
                    <div class="achievement-item">
                        ...
                        <div class="achievement-content">
                            <h4>Первый показ</h4>
                            <p>Участие наших учеников в Mercedes-Benz Fashion Week Russia</p>
                        </div>
                    </div>
                    ...
                    <div class="achievement-item">
                        ...
                        <div class="achievement-content">
                            <h4>Партнёрство с брендами</h4>
                            <p>Начало сотрудничества с Gloria Jeans, ЦУМ и другими ведущими брендами</p>
                        </div>
                    </div>
                    ...
                    <div class="achievement-item">
                        ...
                        <div class="achievement-content">
                            ...
                            <p>Публикация наших моделей в Vogue Italia</p>
                        </div>
                    </div>
                    ...
                    <div class="achievement-item">
                        ...
                        <div class="achievement-content">
                            <h4>Расширение</h4>
                            <p>Открытие нового учебного пространства площадью 500 кв.м</p>
                        </div>
                    </div>
                    ...
                    <div class="achievement-item">
                        ...
                        <div class="achievement-content">
                            <h4>500+ выпускников</h4>
                            <p>Отметка в 500 успешных выпускников, работающих с ведущими брендами</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="about-cta">
                <h3>Готовы начать путь в мир моды?</h3>
                <p>Запишитесь на бесплатный пробный урок и познакомьтесь с нашей школой</p>
        ...
        <div class="container">
            <div class="contact-wrapper">
                <div class="contact-info">
                    ...
                    <h2 class="section-title">Запишитесь<br>на кастинг</h2>
                    <p class="contact-description">
                        Заполните форму, и наш менеджер свяжется с вами в течение 24 часов для записи на бесплатный кастинг
                    </p>
